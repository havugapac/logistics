  ...
  <br><br>
    ...
    <div class="frmDronpDown">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <input type="text" name="function"  class="form-control"  maxlength="16"   placeholder="Function" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select name="type" class="form-control" required>
                    ...
                    <option value="recieptionist">employee</option>
                    
                    <option value="secretary">logistic</option>
                    <option value="human resource">driver</option>
                  </select>
                  </div>
                </div>

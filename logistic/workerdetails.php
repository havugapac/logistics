...
<?php $cnt++; }} ?>
        ...
        <div style="background-color:#d6dbdf"></div>
               ...
               <div class="box dark">
                <header>
            <div class="icons"><i class="fa fa-edit"></i></div>
             <h5 style="color:black;">APPLIED LEAVES</h5>
            <div class="toolbar">
              <nav style="padding: 8px;">
                  <a href="javascript:;" class="btn btn-default btn-xs collapse-box">
                      <i class="fa fa-minus"></i>
...
<?php $cnt++; }} ?>
                ...
                <header>
            <div class="icons"><i class="fa fa-edit"></i></div>
             <h5 style="color:black;">APROOVED LEAVES</h5>
            <div class="toolbar">
              <nav style="padding: 8px;">
                  <a href="javascript:;" class="btn btn-default btn-xs collapse-box">
                      <i class="fa fa-minus"></i>
...
<?php $cnt++; }} ?>
                ...
                <header>
            <div class="icons"><i class="fa fa-edit"></i></div>
             <h5 style="color:black;">WARNINGS</h5>
            <div class="toolbar">
              <nav style="padding: 8px;">
                  <a href="javascript:;" class="btn btn-default btn-xs collapse-box">
                      <i class="fa fa-minus"></i>
...
<?php $cnt++; }} ?>
                ...
                <header>
            <div class="icons"><i class="fa fa-edit"></i></div>
             <h5 style="color:black;">UNAPROOVED LEAVES</h5>
            <div class="toolbar">
              <nav style="padding: 8px;">
                  <a href="javascript:;" class="btn btn-default btn-xs collapse-box">
                      <i class="fa fa-minus"></i>
...
$status='normal'; 
 move_uploaded_file($_FILES["file1"]["tmp_name"],"../img/".$_FILES["file1"]["name"]);        
    ...
    <div class="frmDronpDown">
    <input style="display:none;" type="text" value="<?=$worker?>">
    <input class="form-control" type="file" name="file1" required>
 
                <input style="display:none;" type="text" name="editor" value="<?=$user_id?>">
                <div class="row">
            <div class="col-sm-5"></div></br></br><input type="submit" class="btn btn-success" name="save1" value="CONFIRM">
        </div>
    </div>
    </form>
...
$query->execute();
$lastInsertId3 = $dbh->lastInsertId();
if($lastInsertId3)
{echo "<meta http-equiv='refresh' content='0;url=workerdetails.php?user=".$user."'>";
...
<!-- end of menus -->
            ...
            <footer class="Footer bg-dark dker">
                <p>2019 &copy; FINAL YEAR PROJECT</p>
            </footer>
            <!-- /#footer -->
            <?php
//include 'modals.php';

...
$name='user.png';
  ...
  include("../../connection.php");
              $name='user.png';
        $_Sql="INSERT INTO worker(worker_id,f_name,l_name,gender,dob,m_status,province,district,sector,cell,recret_date,edu_level,nid,account,bank,phone,email,code,password,photo,status,user_id,timess) values (null,'$fname','$lname','$gender','$dob','$m_status','$province','$district','$sector','$cell','$recruitment','$education','$nid1','$account','$bank','$phone','$email','$code1','$password','$name','$status','$useid',null)";
...
<html lang="en">
  ...
  <body style="background-color:#B4B1B0;">
    ...
    <?php
      ...
      <div class="masthead">
        <h3>
          <b><a href="index.php">HUMAN RESOURCE MANAGEMENT SYSTEM</a></b>
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li>
              <a href="home_deductions.php">Blockes Employees</a>
            </li>
            <li>
                    ...
                    <table class="table table-striped" id="myTable">
                      ...
                      <tbody>
                        ...
                        <td align="center"><a href="../workerdetails.php?user=<?php echo $row["worker_id"]; ?>" title="Update"><?php echo $row['code'] ?>,  </a></td>
                          <td align="center"><a href="../workerdetails.php?user=<?php echo $row["worker_id"]; ?>" title="Update"><?php echo $row['f_name'] ?>,  <?php echo $row['l_name'] ?></a></td>
                          ...
                          <td align="center">
                            <a class="btn btn-primary" href="../workerdetails.php?user=<?php echo $row["worker_id"]; ?>">Details</a>
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="#" name="form" method="post">
                <div class="form-group">
                  <label class="col-sm-4 control-label">Firstname<?=$code1?></label>
                  <div class="col-sm-8">

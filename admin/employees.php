...
$drv="no";
  include("../connection.php");
              $name='user.png';
        $_Sql="INSERT INTO worker(worker_id,f_name,l_name,gender,dob,m_status,province,district,sector,cell,recret_date,edu_level,nid,account,bank,phone,email,code,password,photo,status,user_id,timess,driving) values (null,'$fname','$lname','$gender','$dob','$m_status','$province','$district','$sector','$cell','$recruitment','$education','$nid1','$account','$bank','$phone','$email','$code1','$password','$name','$status','$useid',null,'$drv')";

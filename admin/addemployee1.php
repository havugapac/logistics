...
$status='normal';        
    ...
    include("../connection.php");
              $name='user.png';
        $_Sql="INSERT INTO worker(worker_id,f_name,l_name,gender,dob,m_status,province,district,sector,cell,recret_date,edu_level,nid,account,bank,net_salary,phone,email,code,password,photo,status,user_id,timess) values (null,'$fname','$lname','$gender','$dob','$m_status','$province','$district','$sector','$cell','$recruitment','$education','$nid','$account','$bank','$salary','$phone','$email','$code','$password','$name','$status','$user_id',null)";
...
function getkanisa() {
    ...
    $.ajax({          
        ...
        <script src="../bootstrap1/js/jquery-2.1.1.min.js"></script>
         <script>

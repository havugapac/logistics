       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                  ...
                  $disp=mysqli_query($con,"select * from worker,functions,ap_item,items where worker.worker_id=functions.worker_id and worker.worker_id=ap_item.user_id and items.item_id=ap_item.itemname order by ap_id desc");
            ...
            <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="submit" name="jdel" value="Give" class="btn-danger">
                      </form>
                      </td>
                    </tr>
                  </tbody>

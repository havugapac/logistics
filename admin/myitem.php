    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">My Item</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Received item </span>
                  ...
                  $disp=mysqli_query($con,"select * from worker,items,given_items where worker.worker_id=given_items.worker_id and given_items.item_id=items.item_id and worker.worker_id=$user_id order by given_id desc");

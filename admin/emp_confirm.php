...
.succWrap{
 ...
 <thead style="background-color:skyblue;">
                  ...
                  $disp=mysqli_query($con,"select * from worker,traveling,cars,functions where traveling.car_id=cars.car_id and traveling.driver_id=worker.worker_id and functions.worker_id=worker.worker_id and functions.type='driver' and traveling.worker_id='$user_id'");

...
.succWrap{
 ...
 <thead style="background-color:skyblue;">
                  ...
                  $disp=mysqli_query($con,"select * from worker,items,given_items where given_items.worker_id=worker.worker_id and given_items.item_id=items.item_id and worker.worker_id='$user_id' and given_items.confirmation='no'");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="text" name="tid" value="<?php echo $fet['given_id'];?>" style="display:none;">
                        <input type="submit" name="jdel" value="Received" class="btn btn-danger">
                      </form>
                      </td>
                    </tr>
                  </tbody>

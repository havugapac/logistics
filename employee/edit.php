                                    ...
                                    foreach ($_POST["id"] AS $id){
                                                       ...
                                                       $field3 = $_POST["password"];                                   
                                                        ...
                                                        if($file_location){
                                                          ...
                                                          SET email ="'. $field1.' ", phone = "'.$field2.' ",password = "'.$field3.' ", photo = "'.$file_location.' "
                                                          WHERE worker_id = "'.$id.'"';}
                                                        else{
                                                          $update='UPDATE worker
                                                          SET email ="'. $field1.' ", phone = "'.$field2.' ",password ="'. $field3.' "   WHERE worker_id = "'.$id.'"';
                                                        }
...
window.location='edit.php?user=".$id."'</script>";
        ...
        echo "<meta http-equiv='refresh' content='0;url=edit.php?user=".$id."'>";
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" type="text" name="password" value="'.$row["password"].'" placeholder="'.$row["password"].'" required />
                  </div>
            </div>     

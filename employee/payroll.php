                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Payroll Info</span>
...
$year1=$_POST['year'];
$month1=$_POST['month'];
 $sql = "SELECT item_name,f_name,month,year,date1 from worker,given_items,items where worker.worker_id=given_items.worker_id and given_items.item_id= items.item_id";

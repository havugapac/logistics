...
<form action="#" method="post">
   ...
   $insert="insert into outoforder(worker_id,item_id,item_num) values('$emp_id','$itm_id','$nber')";
   ...
   if($remain>0)
    {
    $delt4="update given_items set quantity='$remain' where worker_id='$emp_id' and item_id='$itm_id'";
    $resu4=$con->query($delt4); 

    if($resu4)
    {

   $insert2="insert into outoforder(worker_id,item_id,item_num) values('$emp_id','$itm_id','$nber')";
   $resu4=$con->query($insert2);
